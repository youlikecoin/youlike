...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 YLI from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 YLI in block rewards plus fees, but
        ...
        # Send 100 YLI with subtract fee from amount
        ...
        # Sendmany 100 YLI with subtract fee from amount
