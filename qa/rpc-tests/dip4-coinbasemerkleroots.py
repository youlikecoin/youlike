...
from test_framework.test_framework import YouLikeTestFramework
...
class LLMQCoinbaseCommitmentsTest(YouLikeTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as YouLikeTestFramework doesn't support this atm)
