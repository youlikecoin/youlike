...
Arguments:
    <base_directory> - The base directory of a YouLike Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The YouLike Core developers'
...
Arguments:
    <base_directory> - The base directory of YouLike Core source code repository.
"""
...
Arguments:
    <file> - A source file in the YouLike Core repository.
"""
