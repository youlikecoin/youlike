...
This mechanism has been integrated into Bitcore-Node-YouLike which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/youlikepay/insight-api-youlike#web-socket-api](https://github.com/youlikepay/insight-api-youlike#web-socket-api)
* API: [https://github.com/youlikepay/insight-api-youlike#instantsend-transactions](https://github.com/youlikepay/insight-api-youlike#instantsend-transactions)
