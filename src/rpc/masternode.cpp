...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner YouLike address\n"
            "  payee          - Print the masternode payout YouLike address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting YouLike address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "youlike",               "masternode",             &masternode,             true,  {} },
    { "youlike",               "masternodelist",         &masternodelist,         true,  {} },
    { "youlike",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "youlike",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
