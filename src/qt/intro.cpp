    ...
    signalled(false)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the YouLike block chain.").arg(tr(PACKAGE_NAME)) + " " +
...
bool Intro::pickDataDirectory()
{
     ...
     * override -datadir in the youlike.conf file in the default data directory
     * (to be consistent with youliked behavior)
     */
