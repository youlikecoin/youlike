...
// Copyright (c) 2020 The YouLike Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1606726210, nBits=1e0ffff0, nNonce=6531821, vtx=1)
...
{
    const char* pszTimestamp = "UK set to approve Pfizer BioNTech Covid vaccine within days";
    const CScript genesisOutputScript = CScript() << ParseHex("04e9a67c7bd5ec4e09841214135eedd83a126263cedc122f9c1a82b2655d3baa1df1e4d4a44987bdd5fd2ad9426e6e011186afc1b486ee0980725a7e7ecb255921") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nBudgetPaymentsCycleBlocks = 4380;
        consensus.nBudgetPaymentsWindowBlocks = 100;
        consensus.nSuperblockStartBlock = 2; 
        consensus.nSuperblockStartHash = uint256();
        consensus.nSuperblockCycle = 4380;
        ...
        consensus.defaultAssumeValid = uint256S("0x000000876bd148e53da089dfea28c55b3097e7117ae1f87403b451a6a3d91f9d"); 
        ...
        vAlertPubKey = ParseHex("04ed968b43c34941b1bf6ea4b47e399e55324c54fdfe1a2c02c87881f7f4519bd0203070e60ce9b73f428f3be24d57a8c79afcb7ff3ec200301ce087a101443123");
        nDefaultPort = 25558;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1606726210, 6531821, 0x1e0ffff0, 1, 100 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000000876bd148e53da089dfea28c55b3097e7117ae1f87403b451a6a3d91f9d"));
        assert(genesis.hashMerkleRoot == uint256S("0x74f9f27b9d0aab38bbc1c9a60fc9791aa2594503acf64a7a517ffac869c60d50"));


        vSeeds.push_back(CDNSSeedData("148.251.69.18", "148.251.69.18"));
        ...
        // YouLike BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // YouLike BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // YouLike BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"YmjBYc6YRJD4CHNptyV9Hxo7LeZwd2V8PW"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x000000876bd148e53da089dfea28c55b3097e7117ae1f87403b451a6a3d91f9d"))
        };

        chainTxData = ChainTxData{
            1606726210, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000405fb5263c327903caf87df130ecbdb065b26741ed8478faeee2ba6de97"); 

        pchMessageStart[0] = 0x00;
        pchMessageStart[1] = 0x1a;
        pchMessageStart[2] = 0x7f;
        pchMessageStart[3] = 0x97;
        vAlertPubKey = ParseHex("04b4377c8ca77da4b377a5bd740b6e72f1ca6fe9b8fe74f5f2632e8018f2e6db2dde96271fd0b660e1fe38af5ea13cae3383dda8074cddf21199532680597b8c19");
        nDefaultPort = 35558;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1606726215UL, 2721487UL, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000405fb5263c327903caf87df130ecbdb065b26741ed8478faeee2ba6de97"));
        assert(genesis.hashMerkleRoot == uint256S("0x74f9f27b9d0aab38bbc1c9a60fc9791aa2594503acf64a7a517ffac869c60d50"));
        ...
        // Testnet YouLike BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet YouLike BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet YouLike BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"TFasQDhvFoKSwfrdjtgvoh3XFT7VENr1o8"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000405fb5263c327903caf87df130ecbdb065b26741ed8478faeee2ba6de97"))
        };

        chainTxData = ChainTxData{
            1606726215, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1606726220, 1, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x47bc085ccfe3faa5950f8e9d18492b057400af9171361592084d795811006a3c"));
        assert(genesis.hashMerkleRoot == uint256S("0x74f9f27b9d0aab38bbc1c9a60fc9791aa2594503acf64a7a517ffac869c60d50"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("youlikeevo.org",  "devnet-seed.youlikeevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x47bc085ccfe3faa5950f8e9d18492b057400af9171361592084d795811006a3c"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 7UXRvLHuZQsTErmRLrkjZVbm6mNvBcqtrkUZtdvCCvW2tYbSnhb
        vSporkAddresses = {"TWKTc9zDNn1P82CkFDeqS2JHQCWjcL7AFA"};
        nMinSporkKeys = 1;
        ...
        // Regtest YouLike addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest YouLike script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Regtest YouLike BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest YouLike BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest YouLike BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
